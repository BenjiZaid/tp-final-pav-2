...
namespace Controlador
{
    public class ProveedorManager
    {
        public static Boolean guardarProveedor(Negocio.Proveedor p)
        {
            String sql;
            Boolean b = false;
            sql = "Insert into Proveedor(cod_Proveedor, nombre, domicilio, telefono, mail, nombreContacto, telefonoContacto)" ;
            sql += "values(@cod_Proveedor, @nombre, @domicilio, @telefono, @mail, @nombreContacto, @telefonoContacto)";
            List<SqlParameter> parametros = new List<SqlParameter>();
            parametros.Add(new SqlParameter("@cod_Proveedor", p.Codigo));
            parametros.Add(new SqlParameter("@password", p.Nombre));
            parametros.Add(new SqlParameter("@cod_TipoDNI", p.Domicilio));
            parametros.Add(new SqlParameter("@nroDNI", p.Telefono));
            parametros.Add(new SqlParameter("@apellido", p.Mail));
            parametros.Add(new SqlParameter("@nombre", p.NombreContacto));
            parametros.Add(new SqlParameter("@fecha_Nacimiento", p.TelefonoContacto));
        ...
        public static Boolean modificarProveedor(Negocio.Proveedor p)
        {
            String sql;
            Boolean b = false;
            sql = "Update Proveedor set cod_Proveedor = @cod_Proveedor, nombre = @nombre, domicilio = @domicilio, telefono = @telefono, mail = @mail, nombreContacto = @nombreContacto, telefonoContacto = @telefonoContacto";
            List<SqlParameter> parametros = new List<SqlParameter>();
            parametros.Add(new SqlParameter("@cod_Proveedor", p.Codigo));
            parametros.Add(new SqlParameter("@password", p.Nombre));
            parametros.Add(new SqlParameter("@cod_TipoDNI", p.Domicilio));
        ...
        {
            DataTable dt;
            string sql = "Select * From Proveedor where where cod_Proveedor = @cod_Proveedor";
            List<SqlParameter> parametros = new List<SqlParameter>();
            parametros.Add(new SqlParameter("@cod_Proveedor", codigo));
